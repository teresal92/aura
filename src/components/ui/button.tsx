...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  danger:
    'inline-flex items-center justify-center rounded-full px-1 py-1 text-sm font-medium text-destructive underline decoration-transparent underline-offset-[0.2em] transition-[color,text-decoration-color,opacity] hover:text-aura-foreground-strong hover:decoration-current',
  success:
